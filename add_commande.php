...
/*Je recupère les données des fleurs et des clients pour pouvoir les insérer dans mon select*/
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="date_livraison" class="block text-sm font-medium text-gray-700">Date de
                                    livraison</label>
                            ...
                            <div class="col-span-6 mt-5 sm:col-span-3 lg:col-span-2">
                                ...
                                <!--                                Pour chaque fleurs je crée une balise option avec les fleurs dedans et je fais de même pour mes clients-->
                                <select name="fleur_detail">
                                    <?php foreach ($fleurs as $fleur) { ?>
                                        <?php if ($fleur[5] > 0) { ?>
                                            <option name="fleur"
                                                    value="<?= $fleur[0] . "a" . $fleur[4] ?>"><?= $fleur[1] . " " . $fleur[2] . " fournit par " . $fleur[3] . " " . "(" . $fleur[5] . ")" ?></option>
                                        <?php }
                                    } ?>
                                </select>
                                <?php foreach ($fleurs as $fleur) { ?>
                            ...
                            <div class="col-span-6 mt-5 sm:col-span-3 lg:col-span-2">
                                ...
                                <select name="client">
                                    <?php foreach ($clients as $client) { ?>
                                        <option name="client"
                                                value="<?= $client['id'] ?>"><?= $client['prenom'] . " " . $client['nom'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
